...
# In[31]:
# SRGAAgent(ChallengeSeqDecEnvironment(10000)).generate()
if __name__ == '__main__':
    EvaluateChallengeSubmission(ChallengeSeqDecEnvironment, SRGAAgent, "res1.csv")
    EvaluateChallengeSubmission(ChallengeProveEnvironment, SRGAAgent, "res2.csv")
