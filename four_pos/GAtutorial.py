...
EvaluateChallengeSubmission(ChallengeSeqDecEnvironment, SRGAAgent, "SRGAAgent4seq20.csv")
EvaluateChallengeSubmission(ChallengeProveEnvironment, SRGAAgent, "SRGAAgent4pro20.csv")
